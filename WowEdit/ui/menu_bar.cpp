...
MenuBar::MenuBar()
{
    ...
    menus_ = {
        ...
        Menu("Terrain", {
            Menu("Terrain Tools", {Item("Raise/Lower", "terrain.raise_lower", "T"), Item("Smooth", "terrain.smooth", "S"), Item("Flatten", "terrain.flatten", "L"), Item("Ramp", "terrain.ramp", "R"), Item("Noise", "terrain.noise", "N"), Item("Terrain Stamp/Stencil", "terrain.stamp"), Item("Erosion Simulation...", "terrain.erosion")}),
