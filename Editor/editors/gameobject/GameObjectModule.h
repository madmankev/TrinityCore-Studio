...
public:
    ...
    bool CanUndo() const override { return hasGo && undo_.CanUndo(); }
    bool CanRedo() const override { return hasGo && undo_.CanRedo(); }
    void Undo() override;
    void Redo() override;
...
private:
    ...
    // Snapshot undo/redo (GameObject is fully copyable) — this editor's OWN stack.
    SnapshotStack<GameObject> undo_;
